...
public class Vibrator {
    ...
    private func startVibrateLoopTimer(frequency: Vibrator.Frequency) {
        ...
        vibrateLoopTimer?.invalidate()
        vibrateLoopTimer = Timer.scheduledTimer(timeInterval: frequency.timeInterval, target: self, selector: #selector(playVibrateSystemSound),userInfo: nil, repeats: true)
    }
    ...
    private func startHapticLoopTimer(timeInterval: TimeInterval) {
        ...
        vibrateLoopTimer?.invalidate()
        hapticLoopTimer = Timer.scheduledTimer(timeInterval: timeInterval,target: self, selector: #selector(restartHapticPlayer),userInfo: nil, repeats: true)
    }
