...
install_xcframework "${PODS_ROOT}/APDMyTargetAdapter/APDMyTargetAdapter-2.11.1.2/APDMyTargetAdapter.xcframework" "APDMyTargetAdapter" "library" "ios-x86_64-simulator" "ios-arm64_armv7"
