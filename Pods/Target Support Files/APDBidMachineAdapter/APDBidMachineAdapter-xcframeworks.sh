...
install_xcframework "${PODS_ROOT}/APDBidMachineAdapter/APDBidMachineAdapter-2.11.1.3/APDBidMachineAdapter.xcframework" "APDBidMachineAdapter" "library" "ios-x86_64-simulator" "ios-arm64_armv7"
