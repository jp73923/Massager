...
install_xcframework "${PODS_ROOT}/APDIronSourceAdapter/APDIronSourceAdapter-2.11.1.3/APDIronSourceAdapter.xcframework" "APDIronSourceAdapter" "library" "ios-arm64_armv7" "ios-x86_64-simulator"
