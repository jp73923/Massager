...
install_xcframework "${PODS_ROOT}/Appodeal/Appodeal-2.11.1/Appodeal.xcframework" "Appodeal" "framework" "ios-x86_64-simulator" "ios-arm64_armv7"
...
install_xcframework "${PODS_ROOT}/Appodeal/Appodeal-2.11.1/StackAPI.xcframework" "Appodeal" "framework" "ios-x86_64-simulator" "ios-arm64_armv7"
