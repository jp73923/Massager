...
install_xcframework "${PODS_ROOT}/APDFacebookAudienceAdapter/APDFacebookAudienceAdapter-2.11.1.2/APDFacebookAudienceAdapter.xcframework" "APDFacebookAudienceAdapter" "library" "ios-arm64_armv7" "ios-x86_64-simulator"
