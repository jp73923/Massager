...
install_xcframework "${PODS_ROOT}/StackModules/StackFoundation.xcframework" "StackModules/StackFoundation" "framework" "ios-arm64_i386_x86_64-simulator" "ios-arm64_armv7"
install_xcframework "${PODS_ROOT}/StackModules/StackProductPresentation.xcframework" "StackModules/StackProductPresentation" "framework" "ios-arm64_i386_x86_64-simulator" "ios-arm64_armv7"
install_xcframework "${PODS_ROOT}/StackModules/StackUIKit.xcframework" "StackModules/StackUIKit" "framework" "ios-arm64_i386_x86_64-simulator" "ios-arm64_armv7"
