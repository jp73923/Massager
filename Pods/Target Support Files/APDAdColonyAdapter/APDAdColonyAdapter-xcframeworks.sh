...
install_xcframework "${PODS_ROOT}/APDAdColonyAdapter/APDAdColonyAdapter-2.11.1.3/APDAdColonyAdapter.xcframework" "APDAdColonyAdapter" "library" "ios-x86_64-simulator" "ios-arm64_armv7"
