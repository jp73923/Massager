...
install_xcframework "${PODS_ROOT}/APDUnityAdapter/APDUnityAdapter-2.11.1.2/APDUnityAdapter.xcframework" "APDUnityAdapter" "library" "ios-arm64_armv7" "ios-x86_64-simulator"
