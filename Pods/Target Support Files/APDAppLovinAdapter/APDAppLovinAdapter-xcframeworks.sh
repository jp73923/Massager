...
install_xcframework "${PODS_ROOT}/APDAppLovinAdapter/APDAppLovinAdapter-2.11.1.3/APDAppLovinAdapter.xcframework" "APDAppLovinAdapter" "library" "ios-arm64_armv7" "ios-x86_64-simulator"
