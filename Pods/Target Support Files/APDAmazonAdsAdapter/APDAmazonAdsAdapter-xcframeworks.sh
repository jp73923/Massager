...
install_xcframework "${PODS_ROOT}/APDAmazonAdsAdapter/APDAmazonAdsAdapter-2.11.1.2/APDAmazonAdsAdapter.xcframework" "APDAmazonAdsAdapter" "library" "ios-x86_64-simulator" "ios-arm64_armv7"
