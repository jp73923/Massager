...
install_xcframework "${PODS_ROOT}/APDOguryAdapter/APDOguryAdapter-2.11.1.1/APDOguryAdapter.xcframework" "APDOguryAdapter" "library" "ios-arm64_armv7" "ios-x86_64-simulator"
