...
install_xcframework "${PODS_ROOT}/APDYandexAdapter/APDYandexAdapter-2.11.1.1/APDYandexAdapter.xcframework" "APDYandexAdapter" "library" "ios-x86_64-simulator" "ios-arm64_armv7"
