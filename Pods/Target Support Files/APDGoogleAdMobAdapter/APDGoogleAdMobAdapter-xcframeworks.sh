...
install_xcframework "${PODS_ROOT}/APDGoogleAdMobAdapter/APDGoogleAdMobAdapter-2.11.1.3/APDGoogleAdMobAdapter.xcframework" "APDGoogleAdMobAdapter" "library" "ios-arm64_armv7" "ios-x86_64-simulator"
