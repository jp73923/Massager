...
install_xcframework "${PODS_ROOT}/StackAnalytics/StackAnalytics.xcframework" "StackAnalytics/Base" "framework" "ios-arm64_armv7" "ios-i386_x86_64-simulator"
install_xcframework "${PODS_ROOT}/StackAnalytics/StackCrashReporter.xcframework" "StackAnalytics/Crashes" "framework" "ios-arm64_armv7" "ios-i386_x86_64-simulator"
