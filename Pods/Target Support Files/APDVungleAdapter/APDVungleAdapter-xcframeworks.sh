...
install_xcframework "${PODS_ROOT}/APDVungleAdapter/APDVungleAdapter-2.11.1.2/APDVungleAdapter.xcframework" "APDVungleAdapter" "library" "ios-x86_64-simulator" "ios-arm64_armv7"
