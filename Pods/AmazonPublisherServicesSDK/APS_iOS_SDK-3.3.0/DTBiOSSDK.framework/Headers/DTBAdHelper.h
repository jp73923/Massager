...
// MOPUB
+ (void) prepareMopubObject:(NSObject *)mopub response:(DTBAdResponse * _Nonnull)response;

+ (void) prepareMopubController:(NSObject *)mopub response:(DTBAdResponse * _Nonnull)response controller:(NSObject *)controller;
